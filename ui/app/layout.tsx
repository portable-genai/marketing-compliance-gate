...
export default function RootLayout({
  ...
  // The pills render in BOTH modes, and embedded is the mode that needs them most: a panel
  // inside somebody else's portal is where a viewer has least context about which model
