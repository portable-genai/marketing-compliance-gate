# Mkt6 Marketing Compliance and Brand Governance: Demo UI

A thin demo console for **Mkt6**, the Marketing Compliance and Brand Governance system. It is
a thin presentation layer over the Mkt6 FastAPI backend: it submits a marketing asset (copy +
...
defaults to the Mkt6 API port 8105. Write the override yourself only when the API is
...
```bash
# 1. start the Mkt6 API (from the repo root)
...
| `lib/api.ts`, `lib/types.ts` | The typed client for the Mkt6 FastAPI backend. |
