...
// `<mount>/api` under the portal), so the service lists both headers in the CORS
// `expose_headers`: a cross-origin response hides every header not listed there, and the pills
// would stay on the configured model forever with every test green.
//
