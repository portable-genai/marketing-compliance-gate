...
def build_spec() -> PluginSpec:
    ...
    from marketing_compliance_gate.agent.agent_card import agent_card_document
    ...
    return PluginSpec(
        ...
        license="Apache-2.0",
        repository="https://github.com/portable-genai/marketing-compliance-gate",
        ...
        servers={
            "marketing-compliance-gate": StdioServer(
                command="python",
                args=("-m", "marketing_compliance_gate.mcp"),
                cwd="${PLUGIN_ROOT}",
            )
        },
