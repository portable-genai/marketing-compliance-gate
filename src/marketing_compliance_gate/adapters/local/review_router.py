...
and enqueued (the same transactional outbox the platform adapter flushes to human-review-console),
so tests and the offline demo can assert that an escalation is routed without a running console.
"""
