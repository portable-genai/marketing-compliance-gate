...
class OnPremIdentityAdapter:
    ...
    #: Resolves nobody until a client's IdP is wired in here, so it authenticates no end user.
    #: A deployment that rebinds this port in ``config/settings.yaml`` to its own verifying
    #: adapter is answered about THAT class, not about this placeholder.
